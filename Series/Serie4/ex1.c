...
int main(int argc, char* argv[])
{
  ...
  //  scanf("%d", &N_PASSOS);
    ...
    err_relat = 100.0*( w - exact )/exact;
    printf("RK4, N_PASSOS = %02.d,  w = %.11f, Err Relat. %f\n", N_PASSOS, w, err_relat);
    ...
    err_relat = 100.0*( w - exact )/exact;
    printf("RK2, N_PASSOS = %02.d,  w = %.11f, Err Relat. %f\n", N_PASSOS, w, err_relat);
 ...
 err_relat = 100.0*( w - exact )/exact;
    printf("RK1, N_PASSOS = %02.d,  w = %.11f, Err Relat. %f\n", N_PASSOS, w, err_relat);
    break;
